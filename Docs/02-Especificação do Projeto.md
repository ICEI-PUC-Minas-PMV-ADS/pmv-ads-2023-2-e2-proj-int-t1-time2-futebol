...
|RNF-006| A aplicação deve permitir a criação de gráficos de linhas simples para ilustrar a tendência de desempenho ao longo dos anos para cada estatística.|ALTA |
